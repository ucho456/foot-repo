...
const useJapanMatchData = () => {
  ...
  const enemyTeam = {
    id: 'Spain',
    ref: admin.firestore().doc('teams/Spain'),
    name: 'スペイン'
  }
  ...
  const match: Match = {
    ...
    awayTeam: {
      ...enemyTeam,
      shortName: 'ESP',
      imageUrl: 'https://cdn.pixabay.com/photo/2013/07/13/14/17/spain-162428_960_720.png',
      score: null,
      penalty: null
    },
    lastUpdated,
