...
/**
  ...
  { player: { id: '20', name: 'クォン・ギョンウォン' }, position: 'DF', shirtNumber: 20 },
  ...
  { player: { id: '7', name: 'ナ・サンホ' }, position: 'MF', shirtNumber: 7 },
  { player: { id: '10', name: 'キム・ジンギュ' }, position: 'MF', shirtNumber: 10 },
  { player: { id: '11', name: 'オム・ウォンサン' }, position: 'MF', shirtNumber: 11 },
